...
# --- CLIENTE ---
@replicacion_bp.route("/replicar_cliente", methods=["POST", "PUT"])
...
# --- ASUNTO ---
@replicacion_bp.route("/replicar_asunto", methods=["POST", "PUT"])
def replicar_asunto():
    session = get_session()
    data = request.get_json()
    try:
...
# --- PROCURADOR ---
@replicacion_bp.route("/replicar_procurador", methods=["POST", "PUT"])
...
# --- ABOGADO ---
@replicacion_bp.route("/replicar_abogado", methods=["POST", "PUT"])
...
# --- AUDIENCIA ---
@replicacion_bp.route("/replicar_audiencia", methods=["POST", "PUT"])
...
# --- INCIDENCIA ---
@replicacion_bp.route("/replicar_incidencia", methods=["POST", "PUT"])
